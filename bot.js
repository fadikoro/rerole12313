...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' -help',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,' -help ','bot system prime'];
    var i = -1;
    var j = 0;
...
『-credits ====>  امعرف رصيدك
『-daily ====> لاخذ مكافائتك اليومية
『-v2min ====> لصنع روم صوتي مؤقت
『-inv ====> لدعوة البوت الى سيرفرك
『 0help ====> لمعرفة اوامر الميوزك
『- للدعم الفني قوم بزيارة https://discord.gg/VCwUsSj
『 By ====> fadi
**
`)
